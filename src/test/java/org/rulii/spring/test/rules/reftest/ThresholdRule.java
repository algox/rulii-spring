...
/**
 * Test rule that passes when {@code value} is strictly greater than the configured threshold.
 * Uses a no-arg constructor with a setter — used to verify {@code <class-ref>} with
